...
commentsRouter.get("/", (req, res) => {
  ...
  let selectAllCommentsQuery = `SELECT Comments.id , Comments.isAccept , Comments.body , Comments.date , Comments.hour , Users.firstName as userID ,Users.lastName as userFamily , Products.title as productID from Comments INNER JOIN Users on Users.id = Comments.userID INNER JOIN Products on Products.id =Comments.productID`;
